...
do
    ...
    do
        ...
        do
            ...
            | sort -k 1,1 > ./local_result/20120$j\_ps/20120$j-$k.linux$i.log 
            cat ./local_result/20120$j\_ps/20120$j-$k.linux$i.log \
            | ./02_analysis_ps_reduce.py >> ./local_result/20120$j\_ps_reduced/20120$j-$k.log
        done
    done
done
